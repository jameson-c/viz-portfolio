...
#### Next, a disclaimer
I would like to note that the perpetrators of trafficking are _retailers_ who (generally speaking) sell cash to individuals in exchange for their SNAP benefits. Trafficking is a term of art which embeds a negative connotation to everyone involved in that transaction. However, it is worth noting that SNAP is a program which [prohibits](https://ncoa.org/article/what-can-you-buy-with-snap) funds from being spent on hot food and personal items such as diapers. So it is entirely feasible to me that _people_ who participate in trafficking are simply fulfilling important economic needs which the program does not provide for. In that case, I would not see those dollars as being wasted, necessarily. The issue is complex and deeper than 'trafficking bad.' These considerations are important to Congress, but what to do about it is an entirely separate question.

### The Critique
Rant over. Now, the graph.
...
Which looks better, but given Flourish's limitations I was unable to label the trafficking bubble effectively. Finally, I made yet another data story that more effectively communicated this point:

<iframe src='https://flo.uri.sh/story/1688993/embed' 
        title='Interactive or visual content' 
        class='flourish-embed-iframe' 
        frameborder='0' scrolling='no' 
        style='width:100%;height:600px;' 
        sandbox='allow-same-origin allow-forms allow-scripts allow-downloads allow-popups allow-popups-to-escape-sandbox allow-top-navigation-by-user-activation'></iframe><div style='width:100%!;margin-top:4px!important;text-align:right!important;'><a class='flourish-credit' href='https://public.flourish.studio/story/1688993/?utm_source=embed&utm_campaign=story/1688993' target='_top' style='text-decoration:none!important'><img alt='Made with Flourish' src='https://public.flourish.studio/resources/made_with_flourish.svg' style='width:105px!important;height:16px!important;border:none!important;margin:0!important;'> </a></div>

All said, I am satisfied with the effort and feel that this clearly frames what the original graph was trying to say. There are some things I would change if given more time, however. I wish I had time to explore the wireframe which consolidated both points made here and further that I had a bit more control over labeling in Flourish.
